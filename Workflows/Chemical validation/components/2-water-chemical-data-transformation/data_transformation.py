...
output_dir     = "/mnt/outputs/level1"
os.makedirs(output_dir, exist_ok=True)

# Extract input ZIP to a temporary working directory
extract_dir = "/tmp/output/level0"
...
archivos = [f for f in input_dir.glob("*") if "ALKALINITY" in f.name.upper()]
...
archivos = [f for f in input_dir.glob("*") if "PH_COND_WEIGHTED_RAW" in f.name.upper()]
...
# ============================================================
output_zip_path = "/mnt/outputs/water_chemical_data_level1.zip"
